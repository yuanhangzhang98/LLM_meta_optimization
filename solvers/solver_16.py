...
HYPER_SPACE = {
    ...
    # Design-35 style bounded weak-band release
    ...
    # Below-gamma window geometry (as in 35)
    ...
    # NEW (single principled change vs Design 35): nonzero-floor shaping inside the below-γ window
    # Keeps release active across the entire window (avoid 43-style "too selective" near-zero ramp),
    # while still prioritizing c closer to γ.
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # NEW vs Design 35: floored ramp inside-window (avoid 43’s near-zero ramp over most of window)
