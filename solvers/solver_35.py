...
HYPER_SPACE = {
    ...
    # NEW (single change): bidirectional xl-conditioning of below-γ window width
    # eff_margin = stag_margin * clamp(1 + stag_margin_xl*(2*gate_xl-1), [0.5, 1.5])
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE CHANGE vs Design 78: bidirectional margin modulation (hard wider, easy narrower) with tight caps
