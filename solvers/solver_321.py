...
HYPER_SPACE = {
    # Backbone (seeded from 316 tuned region)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE CHANGE vs 316: stronger self-limiting amplitude at huge xl
    ...
    amp_norm = amp_norm * amp_norm  # square to damp release more at very large xl
