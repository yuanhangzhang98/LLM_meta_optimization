...
HYPER_SPACE = {
    ...
    # NEW (one change vs Design 83): symmetric power-odds warp exponent
    # sw = s^p / (s^p + (1-s)^p); p=1 gives identity, p>1 steepens mid-curve with flat edges.
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # In-window amplitude shaping: smootherstep -> (NEW) symmetric power-odds warp -> power
    ...
    # NEW: symmetric warp family (monotone, bounded, flat edges for p>1)
