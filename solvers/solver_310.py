...
HYPER_SPACE = {
    # Backbone (seeded from 302/305 tuned region)
    ...
    # xl-gated tail shift (305)
    "tail_mu": dict(type="uniform", default=0.12, low=0.0, high=0.50),

    # NEW (single change vs 305): self-limiting release amplitude at huge xl (303)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # tail-safety gate with xl-gated shift (305)
    ...
    # NEW: self-limiting amplitude when xl is huge (303)
