...
HYPER_SPACE = {
    ...
    # High-xl release gain (Design 114)
    "xl_gain": dict(type="uniform", default=0.6, low=0.0, high=2.0),

    # ONE CHANGE vs Design 114: make the high-xl gain breakpoint tunable in gate-space
    # xl_mid=0.5 reproduces 114; smaller activates earlier, larger later.
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ===== High-xl gain on release (Design 114), but with tunable breakpoint xl_mid =====
    ...
    # Piecewise-linear ramp: 0 below xl_mid, 1 at gate_xl=1
