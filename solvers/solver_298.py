...
HYPER_SPACE = {
    # Baseline backbone (seeded from Design 285 tuned region)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # Baseline xs rhs + (NEW) bounded weak-band release
    ...
    # upward-only bounded push toward xs_star
    ...
    release = kappa * gate_xl * weak_band * push_up
