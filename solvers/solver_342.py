...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ===== SINGLE CHANGE vs 335: clause-state-conditioned xl-temp =====
    # Only soften the window when we are actually in the release regime.
    adapt_mask = (weak_band * window_raw).clamp(0.0, 1.0)
