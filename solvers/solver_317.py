...
HYPER_SPACE = {
    ...
    # xl-gated tail shift (anti-starvation, as in 316)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # tail-safety gate (anti-starvation sign as in 316)
    ...
    # SINGLE CHANGE vs 316: soften huge-xl damping to reduce late-stage starvation
    ...
    amp_norm = torch.sqrt(amp_base.clamp_min(0.0))
