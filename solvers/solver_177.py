...
HYPER_SPACE = {
    ...
    # Design-142 assist (smooth c-gate + super-saturating effective pressure)
    ...
    # NEW (single change vs Design-142): high-pressure tail damper threshold
    # For pressure >> p_cut, assist is additionally suppressed ~ 1/(pressure/p_cut)^2.
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # Design-142 p_eff: peaks near p~p_sat, then decays ~ p_sat^2/p
    p_eff = (p_sat * pressure / denom) * (p_sat / denom)

    # NEW: additional smooth suppression for very large pressure to protect large-N tail
