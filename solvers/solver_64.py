...
HYPER_SPACE = {
    ...
    # Gate threshold/sharpness for the bounded normalized tie-gap
    # gap_n = gap / (gap + spread) is naturally well-conditioned and in [0, 0.5]
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE PRINCIPLED CHANGE: bounded, well-conditioned fractional gap normalization
    # gap_n in [0, 0.5]; avoids blow-ups when spread is tiny and is robust across clause scales
