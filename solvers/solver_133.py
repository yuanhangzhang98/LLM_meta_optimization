...
HYPER_SPACE = {
    ...
    # NEW: coupled normalization knob (dv-anchored; prevents memory runaway when dv is small)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ---- MODIFICATION: coupled, dv-anchored normalization with memory-aware floor ----
    dv_max = dv.abs().max()
