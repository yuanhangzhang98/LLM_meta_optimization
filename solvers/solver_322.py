...
HYPER_SPACE = {
    ...
    # Self-limiting amplitude at huge xl (now tunable exponent)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE CHANGE vs 321: amp_norm uses tunable exponent (monotone, bounded)
    ...
    amp_norm = torch.pow(amp_base, amp_p)
