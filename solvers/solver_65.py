...
HYPER_SPACE = {
    ...
    # NEW (single change): robust magnitude floor for normalized-gap tie detection
    # gap_n = (u2-u1)/(u1+u2+g_floor)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE MODIFICATION vs Design 11: scale-invariant tie metric
