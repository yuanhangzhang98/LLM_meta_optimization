...
HYPER_SPACE = {
    # Backbone defaults (from best-known tuned region around Design 215)
    ...
    # NEW (single change vs Design 215): sigmoid sharpness for hi-ramp in gate-space
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ===== Hi-ramp breakpoint shift (as in Design 215) =====
    ...
    # ===== SINGLE CHANGE vs Design 215: logit-shaped (sigmoid) hi-ramp in gate-space =====
    ...
    # Normalize so that hi=0 at gate_xl=xl_mid_eff, and hi=1 at gate_xl=1
