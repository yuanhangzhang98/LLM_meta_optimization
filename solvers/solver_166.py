...
HYPER_SPACE = {
    ...
    # Top-2 assist (Design 61), bounded via pressure saturation
    ...
    # NEW (single change vs Design 61): smooth trigger sharpness
    "kappa":   dict(type="log_uniform", default=20.0,              low=0.5,  high=200.0),
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ===== Assist (Design 61) with saturated pressure, but smooth trigger =====
    ...
    # smooth gate in (0,1)
    gate = torch.sigmoid(kappa * (c - c_thr))
