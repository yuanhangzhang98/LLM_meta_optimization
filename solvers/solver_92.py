...
HYPER_SPACE = {
    ...
    # Clause-adaptive rigidity routing temperature:
    # tau_m = tau_floor + tau_span * xs_m  (xs_m -> 0 for satisfied clauses => sharp routing near solutions)
    "tau_floor": dict(type="log_uniform", default=1e-3, low=1e-5, high=5e-2),
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ===== RIGIDITY TERM R (ONLY CHANGE): clause-adaptive top-2 routing =====
    tau = (hp.tau_floor + hp.tau_span * xs).clamp(min=1e-6)  # (M,)
