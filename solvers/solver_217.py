...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ===== SINGLE CHANGE vs Design 213: make breakpoint coupling ASYMMETRIC (delay-only) =====
    # Keep band-limited proximity signal, but only delay hi-gain when not near;
    # when near_eff->1, xl_mid_eff->0.5 (tail behavior preserved).
    ...
    xl_mid_eff = (mid0 + mid_shift * (1.0 - near_eff)).clamp(0.05, 0.95)
