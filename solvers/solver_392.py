...
HYPER_SPACE = {
    ...
    # Over-gamma shoulder (relative width), PLUS absolute cap (single principled tightening)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # --- SINGLE CHANGE vs 389: cap the relative over-gamma shoulder by an absolute width ---
