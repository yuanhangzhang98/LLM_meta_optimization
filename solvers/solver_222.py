...
HYPER_SPACE = {
    # Backbone defaults (from best-known tuned region; Design 43)
    ...
    # Bounded weak-band release (Design 43)
    ...
    # ONE-SIDED below-gamma window geometry (Design 43)
    ...
    # In-window amplitude shaping (Design 43)
    ...
    # Bounded xl-dependent gain on release amplitude (Design 43)
    "xl_gain": dict(type="uniform", default=0.8, low=0.0, high=2.0),

    # --- SINGLE PRINCIPLED CHANGE vs Design 43 ---
    # Safe xl-adaptive sharpening with a cap to avoid starving near-gamma release.
    # stag_sharp_eff = max(stag_sharp / (1 + stag_sharp_gain*gate_xl), stag_sharp*sharp_min_ratio)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # --- SINGLE CHANGE: safe xl-adaptive sharpening with capped maximum sharpening ---
    ...
    # Design 43: bounded xl-dependent gain on release amplitude
