...
HYPER_SPACE = {
    ...
    # NEW (single conceptual change vs 318): cap the warped logit to bound edge sharpness
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE CHANGE vs 318: cap the warped logit (bounds edge sharpness / sensitivity)
    logit_w_warp = torch.clamp(logit_w * win_p, -cap, cap)
