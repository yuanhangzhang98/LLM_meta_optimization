...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ===== Tail-only hi boost (from 244) + endgame gating (from 246) =====
    ...
    # SINGLE CHANGE vs Design 246:
    # gate tail boost by a stricter endgame indicator that also requires high hi.
    g = (weak_band * near_gamma * hi).clamp(0.0, 1.0)
