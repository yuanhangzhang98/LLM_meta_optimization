...
HYPER_SPACE = {
    ...
    # ONE-SIDED below-gamma window geometry
    ...
    # xl-adaptive sharpening of the window (Design 220)
    "stag_sharp_gain": dict(type="uniform", default=1.5,                low=0.0,  high=10.0),
    ...
    # xl-dependent gain knob (now used as delayed hi-ramp gain)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # xl-adaptive sharpening (Design 220)
    ...
    stag_sharp_eff = (stag_sharp / (1.0 + stag_sharp_gain * gate_xl)).clamp_min(1e-6)
    ...
    # --- SINGLE CHANGE vs Design 220 ---
    # Replace always-on quadratic amp_xl with convex delay-only hi-ramp breakpoint (Design 219).
    ...
    hi = t_hi * t_hi * t_hi * (t_hi * (t_hi * 6.0 - 15.0) + 10.0)  # C^2
