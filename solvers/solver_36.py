...
HYPER_SPACE = {
    ...
    # In-window amplitude shaping (Design 76/81)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ONE change vs Design 81: apply fixed rational warp AFTER quintic smootherstep (smootherstep -> warp).
    ...
    # NEW: fixed warp after smoothing
