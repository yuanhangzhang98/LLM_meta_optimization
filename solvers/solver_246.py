...
HYPER_SPACE = {
    ...
    # NEW (single principled change vs 244): endgame gating threshold for tail boost
    # Tail boost activates only when g = weak_band * near_gamma is high.
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ===== Tail-only hi boost (from 244) + NEW endgame gating =====
    ...
    # NEW: gate tail boost by endgame indicator g = weak_band * near_gamma
