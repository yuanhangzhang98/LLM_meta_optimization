...
HYPER_SPACE = {
    ...
    # SINGLE CHANGE vs 327: xl-adaptive *sharpening* of window edges (opposite of 329)
    "xl_edge_gain": dict(type="uniform", default=1.0, low=0.0, high=5.0),
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE CHANGE vs 327: sharpen edges for high-xl clauses
    xl_edge_gain = torch.as_tensor(hp.xl_edge_gain, device=v.device, dtype=v.dtype).clamp_min(0.0)
    win_p_eff = win_p * (1.0 + xl_edge_gain * gate_xl)  # (M,)
