...
HYPER_SPACE = {
    ...
    # NEW (single change vs design 390): mix between 388 (near-γ) and 390 (near-η) floor shapes
    # 0 -> 388 shape (s^p); 1 -> 390 shape ((1-s)^p)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # floor shape in weak band (smoothstep coordinate s in [0,1])
    ...
    # ---- SINGLE CHANGE vs design 390: mix 388 and 390 floor geometries ----
