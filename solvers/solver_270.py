...
HYPER_SPACE = {
    # Baseline (best-known defaults from Design 51/42 lineage)
    ...
    # Bounded weak-band release (Design 51/42)
    ...
    # Below-gamma window geometry (Design 42)
    ...
    # In-window amplitude shaping (Design 83/42)
    ...
    # Symmetric power-odds warp exponent (Design 42)
    "warp_sym_p": dict(type="uniform",     default=2.0,                  low=1.0,  high=6.0),

    # NEW (single change vs Design 42): bidirectional xl-conditioning of below-γ window width
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # NEW (single change vs Design 42): bidirectional xl-conditioning of window width
