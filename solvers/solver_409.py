...
HYPER_SPACE = {
    ...
    # NEW (single change): smooth hinge sharpness for turning on the over-gamma decay
    "hinge_sharp": dict(type="log_uniform", default=0.02, low=1e-3, high=0.20),
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # --- SINGLE CHANGE vs design 399 ---
    # Smooth-hinge overshoot: softplus shift ensures overshoot=0 at c=gamma_hi,
    # giving below_gamma=1 there, saturating to 1 below, and turning on decay smoothly.
    ...
    overshoot = (F.softplus(x) - math.log(2.0)) * hinge_sharp
