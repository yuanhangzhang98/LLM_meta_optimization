...
HYPER_SPACE = {
    # Backbone defaults (from best-known tuned region; Design 48)
    ...
    # Bounded weak-band release (Design 48)
    ...
    # Below-gamma window geometry (Design 48, one-sided)
    ...
    # In-window amplitude shaping (Design 48)
    ...
    # High-xl release gain (Design 48)
    ...
    # NEW (single change vs Design 48): smooth high-pressure damping on p = xl*xs
    # p_eff = p / (1 + (p/p_cut)^nu). For p<<p_cut, p_eff≈p (no global damping).
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # --- SINGLE CHANGE vs Design 48: damp extreme pressure p=xl*xs ---
    ...
    # High-xl gain on release (unchanged)
