...
HYPER_SPACE = {
    ...
    # In-window floor geometry: convex power + small linear term (late-but-not-too-late)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE CHANGE vs 373: convex power + small linear component (controls onset without concavity)
    ...
    shape = (floor_lin_frac * t + (1.0 - floor_lin_frac) * torch.pow(t, floor_pow)).clamp(0.0, 1.0)
