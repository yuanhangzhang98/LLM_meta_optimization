...
HYPER_SPACE = {
    # Baseline (best-known defaults from Design 51 / carried into 38)
    ...
    # ONE CHANGE vs Design 38: tunable post-power warp exponent (p=2 recovers 38)
    "warp_p":   dict(type="uniform",     default=2.0,                    low=1.0,  high=8.0),
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # In-window amplitude shaping: smootherstep -> power -> (tunable) warp
    ...
    # ONE CHANGE: tunable rational warp exponent
    ...
    sw = sp / (sp + (1.0 - sp).clamp_min(0.0).pow(warp_p) + eps)
