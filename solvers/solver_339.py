...
HYPER_SPACE = {
    ...
    # Self-limiting amplitude at huge xl + (now) clause-state-driven floor
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # --- SINGLE CHANGE vs 336: clause-state-driven floor activation ---
    # Soft-OR of existing clause-state signals (no delayed gate_xl ramp; avoids squaring small gates).
    floor_gate = (1.0 - (1.0 - weak_band) * (1.0 - push_up)).clamp(0.0, 1.0)
