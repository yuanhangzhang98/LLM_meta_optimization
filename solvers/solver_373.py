...
HYPER_SPACE = {
    ...
    # NEW: convex/late-acting floor within safe window (>=1 => not early-strong)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE PRINCIPLED CHANGE vs 367: convex, late-acting floor coupling
    floor_pow = torch.as_tensor(hp.floor_pow, device=v.device, dtype=v.dtype).clamp_min(1.0)
    amp_floor_eff = (amp_floor * torch.pow(t, floor_pow)).clamp(0.0, 0.95)
