...
HYPER_SPACE = {
    ...
    # NEW (single principled change vs Design 43): xl-adaptive sharpening of the window
    # stag_sharp_eff = stag_sharp / (1 + stag_sharp_gain * gate_xl)
    "stag_sharp_gain": dict(type="uniform", default=1.5,                low=0.0,  high=10.0),

    # In-window amplitude shaping (as in Design 106/43)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # NEW: xl-adaptive sharpening (more localized targeting for high-xl clauses)
