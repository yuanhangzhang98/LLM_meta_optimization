...
HYPER_SPACE = {
    # baseline / 208-family defaults (from 258/259)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE CHANGE vs Design 259: C∞ compact-support bump tie window
    # w=1 for gap<=g0, w=0 for gap>=g0+kappa; C∞ transition in between.
    ...
    # soft-min over top-2 only (avoid changing clause semantics away from ties)
    tau = hp.tau_tie
