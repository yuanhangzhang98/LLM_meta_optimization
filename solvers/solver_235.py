...
HYPER_SPACE = {
    ...
    # NEW (single modification): shifted-tanh warp parameters for sw(s)
    # sw = normalize(tanh(k*(s-mu))) with mu controlling center (breakpoint) and k controlling steepness.
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # --- SINGLE CHANGE vs Design 215: tunable shifted-tanh warp, normalized to [0,1] ---
