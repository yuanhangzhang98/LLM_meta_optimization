...
HYPER_SPACE = {
    ...
    # In-window amplitude shaping (Design 51) + ONE SMALL CHANGE: add dead-zone fraction
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # In-window amplitude: ONE CHANGE vs Design 51 -> add dead-zone fraction win_tau
    ...
    amp = win_floor + (1.0 - win_floor) * t2.pow(win_pow)
