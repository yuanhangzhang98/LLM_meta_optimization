...
HYPER_SPACE = {
    # Baseline backbone (seeded from best-known tuned region used in 298/233/287)
    ...
    # Weak-band xs release (as in 298)
    ...
    # NEW (tail-safety): smoothly shut off release once xs is already high
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # NEW tail-safety: disable release once xs is already high
