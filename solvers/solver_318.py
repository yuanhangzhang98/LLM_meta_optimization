...
HYPER_SPACE = {
    ...
    # Window warp strength (same knob name as 315, but used as logit-temperature)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # --- SINGLE CHANGE vs Design 315: logit-temperature warp of the window ---
    # window_raw in [0,1]; apply monotone bounded warp: sigmoid(logit(w)*p)
    ...
    window = torch.sigmoid(logit_w * win_p)
