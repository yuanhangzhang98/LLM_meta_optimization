...
HYPER_SPACE = {
    ...
    # SINGLE CHANGE DRIVER: allow a small smooth shoulder above gamma in the window upper edge
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # --- SINGLE CHANGE vs 383: widen the upper edge to gamma+over_gamma (smooth shoulder above gamma) ---
    ...
    below_gamma = torch.sigmoid((gamma_hi - c) / stag_sharp)
