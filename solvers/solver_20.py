...
HYPER_SPACE = {
    ...
    # Design-35/47 style bounded weak-band release
    ...
    # In-window amplitude shaping (Design 47) + SINGLE CHANGE: power-shaped ramp
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # In-window amplitude: SINGLE CHANGE vs Design 47 (linear -> power-shaped)
