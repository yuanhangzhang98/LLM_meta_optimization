...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ===== Delay-only hi-ramp coupling (Design 217) with ONE small change =====
    # Change mapping: linear (1-near_eff) -> concave sqrt(1-near_eff), increasing delay for mid-range near_eff.
    ...
    one_minus = (1.0 - near_eff).clamp(0.0, 1.0)
    xl_mid_eff = (mid0 + mid_shift * torch.sqrt(one_minus)).clamp(0.05, 0.95)
