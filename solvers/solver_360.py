...
HYPER_SPACE = {
    ...
    # Bounded, gated release (as in the 352/354/356/358 family)
    ...
    # SINGLE CHANGE (tail-safe, monotone cap): cap temperature influence to avoid over-suppression
    "temp_cap": dict(type="uniform", default=5.0, low=0.0, high=20.0),
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE CHANGE: cap temperature influence (monotone, smooth, no cutoff/shift)
