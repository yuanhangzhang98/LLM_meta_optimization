...
def _grad_single(vars, idx, sgn, hp):
    ...
    # --- SINGLE CHANGE vs 392: width-aware upper-edge sharpness (still coupled to stag_sharp) ---
    over_sharp_eff = (stag_sharp + 0.25 * width).clamp_min(1e-6)
    below_gamma = torch.sigmoid((gamma_hi - c) / over_sharp_eff)
