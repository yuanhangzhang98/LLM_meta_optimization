...
HYPER_SPACE = {
    ...
    # Self-limiting amplitude at huge xl
    "xl_norm": dict(type="log_uniform", default=15292.311320487264, low=1e3, high=1e6),

    # SINGLE CHANGE vs 321: positive floor for amp_norm (keeps release possible at xl→∞)
    "amp_floor": dict(type="log_uniform", default=0.02, low=1e-4, high=0.2),
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # amp_norm with floor (bounded, monotone, tail-safe)
