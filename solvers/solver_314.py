...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE CHANGE vs baseline: regime-aware xl growth (selective stability)
    # xl only grows/shrinks when the clause is in the "active/violated" regime (xs high).
    dxl = hp.alpha * (xs * (c - hp.delta))
