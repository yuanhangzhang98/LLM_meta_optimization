...
HYPER_SPACE = {
    ...
    # NEW (single change): require true xs-decay for tail_floor engagement
    "tail_rhs_thr":   dict(type="uniform",     default=0.01,  low=0.0,  high=0.10),
    "tail_rhs_sharp": dict(type="log_uniform", default=0.02,  low=1e-3, high=0.20),
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ---- SINGLE CHANGE vs design 406 ----
    # Tail-floor engages only if xs is truly decaying (rhs_base sufficiently negative).
