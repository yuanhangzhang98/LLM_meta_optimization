...
HYPER_SPACE = {
    # Baseline (kept at best-known defaults from Design 51)
    ...
    # In-window amplitude shaping (ONE change is in the functional form)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # In-window amplitude: ONE CHANGE vs Design 51
    # power ramp t -> quintic smootherstep s(t)=6t^5-15t^4+10t^3 (C^2, flat edges)
