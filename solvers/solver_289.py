...
def _grad_single(vars, idx, sgn, hp):
    ...
    # Gate the *base* floor contribution by near_from_below so it only widens the band
    # when clauses are close to entering the below-gamma window, not far below it.
    ...
    band_floor = band_sharp_abs_min * (1.0 + need * (base * near_from_below + (1.0 - base) * window))
