...
HYPER_SPACE = {
    # Backbone (seed from 322 tuned region)
    ...
    # Self-limiting amplitude at huge xl (322) + NEW: xl-conditional floor
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # amp_norm: 322 power-law + NEW xl-conditional floor (no effect when gate_xl≈0)
    ...
    # tighten conditioning: floor turns on mainly when gate_xl is high
    floor_xl = (amp_floor * gate_xl * gate_xl).clamp(0.0, 1.0)
