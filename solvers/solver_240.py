...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE CHANGE vs Design 238: soften upper edge to avoid starving release near gamma
    weak_band = w_lo * torch.sqrt(w_hi.clamp_min(0.0))
    ...
    # ===== Delay-only hi-ramp coupling (Design 219) as in 238 (no weak_band in breakpoint) =====
