...
HYPER_SPACE = {
    ...
    # SINGLE NEW DOF vs 329:
    # apply xl-temp ONLY in the extreme tail: threshold = xl_tail_mult * xl_thr
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # xl gate in log-space (used for release as in 329)
    ...
    # SINGLE CHANGE vs 329: tail-only xl-adaptive temperature
