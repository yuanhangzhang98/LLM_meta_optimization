...
HYPER_SPACE = {
    ...
    # Coupled normalization knobs (from Designs 8/32)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ---- p-norm robust stats + capped coupled normalization ----
    ...
    # SINGLE CHANGE vs Design 32: smooth (L2) coupling instead of hard max
