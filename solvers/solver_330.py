...
HYPER_SPACE = {
    # Backbone (seeded from 322 tuned region)
    ...
    # Self-limiting amplitude at huge xl (SINGLE CHANGE vs 322: log-xl Hill decay)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # tail-safety gate (anti-starvation sign as in 316/321/322)
    ...
    # SINGLE CHANGE vs 322: log-xl Hill amp_norm (1 up to xl_norm, then smooth monotone decay)
    ...
    t = torch.relu(log_xl - log_norm)
    amp_norm = (1.0 / (1.0 + torch.pow(t / amp_sigma, amp_p))).clamp(0.0, 1.0)
