...
def _grad_single(vars, idx, sgn, hp):
    ...
    # Temperature tied to geometric mean of existing gate params (kappa, g0)
    # to keep smooth-max sharp when g0 is small and avoid underestimating gap at larger kappa.
    t = max(0.25 * math.sqrt(float(hp.kappa) * float(hp.g0)), 1e-4)
