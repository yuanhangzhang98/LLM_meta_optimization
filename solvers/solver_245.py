...
HYPER_SPACE = {
    ...
    # SINGLE CHANGE vs Design 240: logit-shift warp for the upper weak-band edge
    # shift=logit(sqrt(0.5))≈0.88137 reproduces sqrt at w_hi=0.5 (c=gamma).
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # --- SINGLE CHANGE vs 240: replace sqrt(w_hi) with bounded logit-shift warp ---
    ...
    # ===== Delay-only hi-ramp coupling (breakpoint independent of weak_band) =====
