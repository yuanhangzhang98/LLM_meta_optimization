...
HYPER_SPACE = {
    ...
    # In-window amplitude shaping (unchanged knobs; ONLY ramp function changes in code)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # xl gate in log-space (unchanged)
    ...
    # In-window amplitude: ONLY CHANGE vs Design 67
    # Use 7th-order smoothstep (C^3 flat edges): s(t) = -20 t^7 + 70 t^6 - 84 t^5 + 35 t^4
    ...
    t6 = t5 * t
    t7 = t6 * t
    s = (-20.0 * t7) + (70.0 * t6) - (84.0 * t5) + (35.0 * t4)
    ...
    amp = win_floor + (1.0 - win_floor) * s.clamp(0.0, 1.0).pow(win_pow)
