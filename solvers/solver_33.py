...
HYPER_SPACE = {
    # Baseline (best-known defaults from Design 78)
    ...
    # Below-gamma window geometry (Design 78)
    ...
    # NEW (single change): xl-conditioned widening of the below-gamma window
    # eff_margin = stag_margin * (1 + stag_margin_xl * gate_xl)
    "stag_margin_xl": dict(type="uniform", default=0.0, low=0.0, high=3.0),
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # Weak-sat band: eta < c < gamma (UNCHANGED)
    ...
    # SINGLE CHANGE: widen this window only for high-xl clauses
    ...
    eff_margin = (stag_margin * (1.0 + stag_margin_xl * gate_xl)).clamp(0.0, 0.49)
