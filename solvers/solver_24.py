...
HYPER_SPACE = {
    ...
    # Bounded weak-band release (keep unchanged to isolate causality)
    ...
    # Below-gamma window geometry (keep unchanged)
    ...
    # In-window amplitude shaping (same params as 49/51)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ===== SINGLE CHANGE vs Design 49/51: smoothstep(power-ramp) amplitude =====
    ...
    u = t.pow(win_pow)
    smooth = u * u * (3.0 - 2.0 * u)  # in [0,1], monotone
