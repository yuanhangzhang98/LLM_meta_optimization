...
HYPER_SPACE = {
    ...
    # In-window amplitude shaping (Design 76) + ONE SMALL CHANGE HERE (see _grad_single)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # In-window amplitude:
    # SAME as Design 76 except ONE CHANGE: apply quintic smootherstep to t2 before win_pow.
    ...
    # NEW vs Design 76: quintic smootherstep on t2
