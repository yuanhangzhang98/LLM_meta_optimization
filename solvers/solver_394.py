...
HYPER_SPACE = {
    ...
    # In-window floor geometry (as in 375/388)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # tail-safety gate (SINGLE CHANGE vs 388: tighten with xl instead of loosening)
    ...
    # floor shape in weak band (as in 375/388)
