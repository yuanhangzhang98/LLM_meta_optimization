...
HYPER_SPACE = {
    ...
    # Mix between near-γ and near-η floor shapes (as in 391)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ---- SINGLE CHANGE vs design 391 ----
    # Make xl-loosening of the tail gate engage mainly near-γ (s→1),
    # protecting deep-in-band satisfied clauses from flip cascades.
    gate_tail = torch.sigmoid((xs_tail - xs + tail_mu * gate_xl * s) / xs_tail_sharp).clamp(0.0, 1.0)
