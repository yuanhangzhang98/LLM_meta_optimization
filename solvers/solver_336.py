...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE CHANGE vs 332: make floor independent of gate_xl to avoid double-gating
    # (release already multiplies gate_xl; this keeps the effective floor ~ gate_xl*amp_floor, not gate_xl^2)
    floor_xl = amp_floor
