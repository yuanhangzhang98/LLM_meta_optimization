...
def _grad_single(vars, idx, sgn, hp):
    ...
    # Compact-support tie gate with smoother boundary than cubic smoothstep:
    # t=1 for gap<=g0-kappa, t=0 for gap>=g0
    t = ((hp.g0 - gap) / hp.kappa).clamp(0.0, 1.0)
    # Quintic smoothstep: C2 at both ends (reduces unintended activation/forces near cutoff)
    w = (t * t * t * (10.0 - 15.0 * t + 6.0 * t * t)).clamp(0.0, 1.0)
