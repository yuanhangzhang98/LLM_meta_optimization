...
def _grad_single(vars, idx, sgn, hp):
    ...
    # SINGLE MODIFICATION (vs Design-21): conservative smooth-max for stable tie gradients
    # Keep conservativeness by tying temperature to existing kappa (no new hyperparameter).
