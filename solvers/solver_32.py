...
HYPER_SPACE = {
    ...
    # In-window amplitude shaping (Design 51) + dead-zone fraction (Design 76)
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # keep dead-zone win_tau (Design 76), but apply a fixed smooth warp + quintic smootherstep
    ...
    # NEW (single change vs Design 76): warp then smootherstep
    # warp: t2 -> tw = t2 / (t2 + (1-t2)^2)
