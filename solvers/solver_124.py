...
HYPER_SPACE = {
    ...
    # NEW: leak rate for xl (prevents runaway + enables forgetting of stale large weights)
    "lambda_l":  dict(type="log_uniform", default=5.0,  low=1e-1, high=50.0),
}
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # ONLY CHANGE vs baseline: damped multiplicative xl update
    # dxl = alpha*(c-delta)*xl  -  lambda_l*(xl-1)
    dxl = hp.alpha * (c - hp.delta) * xl - hp.lambda_l * (xl - 1.0)
