...
HYPER_SPACE = {
    ...
    # NEW (single change vs 302): xl-gated tail shift to prevent re-entry of high-xl clauses
    # tail_mu=0 recovers 302.
...
def _grad_single(vars, idx, sgn, hp):
    ...
    # tail-safety gate (MODIFIED): xl-gated shift to prevent re-entry when xl is high
    ...
    # When gate_xl~1 (persistently hard/high-xl), effective tail threshold shifts down by tail_mu,
    # so release remains disabled unless xs drops well below xs_tail.
